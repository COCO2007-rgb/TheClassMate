...
const Leaderboard = ({ items = [], isAnonymous = false }) => {
    ...
    <div className="bg-white dark:bg-primary border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden shadow-sm">
      <div className="p-4 bg-primary text-white flex items-center justify-between border-b border-gray-850">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-bold text-sm">Class Performance Leaderboard</h3>
        </div>
      ...
      <div className="divide-y divide-gray-100 dark:divide-gray-850">
        {sorted.length === 0 ? (
          <div className="p-8 text-center text-xs text-gray-500 dark:text-gray-400">
            No entries loaded for this exam.
          </div>
        ) : (
          sorted.map((item, index) => {
            ...
            return (
              <div
                ...
                className="flex items-center justify-between p-3.5 hover:bg-gray-50/50 dark:hover:bg-gray-850/50 transition-all"
              >
                <div className="flex items-center space-x-3.5">
                  ...
                  <div className="w-6 flex justify-center">
                    {rank === 1 ? (
                      ...
                      <Award size={20} className="text-gray-400 fill-gray-400" />
                    ) : rank === 3 ? (
                      <Award size={20} className="text-amber-700 fill-amber-700" />
                    ) : (
                ...
                <div className="text-right">
                  <span className="text-xs font-bold text-primary dark:text-white bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
                    {item.score} Marks
                  </span>
                  {item.percentage && (
